...
void fillTree(TTree *Run_Tree, HTauTauTree_et *tree, int entry_tree, int recoil, bool ismc){
    ...
    if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0){
        ...
        mymet=mymet+tau2-1.060*tau2;
        mymet_UESDown=mymet_UESDown+tau2-1.060*tau2;
        mymet_UESUp=mymet_UESUp+tau2-1.060*tau2;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-1.060*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-1.060*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-1.060*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-1.060*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-1.060*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-1.060*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-1.060*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-1.060*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-1.060*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-1.060*tau2;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau2-1.060*tau2;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau2-1.060*tau2;
    }
    else if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==0){
        mymet=mymet+tau2-1.000*tau2;
        mymet_UESDown=mymet_UESDown+tau2-1.000*tau2;
        mymet_UESUp=mymet_UESUp+tau2-1.000*tau2;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-1.000*tau2;
