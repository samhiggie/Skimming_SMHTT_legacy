...
void fillTree(TTree *Run_Tree, HTauTauTree_mt *tree, int entry_tree, int recoil, bool ismc){
    ...
    njets = tree->jetVeto30WoNoisyJets;//FIXME
    ...
    njets_JetRelativeBalUp = tree->jetVeto30WoNoisyJets; //FIXME
    njets_JetRelativeBalDown = tree->jetVeto30WoNoisyJets; //FIXME
    ...
    if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==0){
        ...
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-0.982*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-0.982*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-0.982*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-0.982*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-0.982*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-0.982*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-0.982*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-0.982*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-0.982*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-0.982*tau2;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau2-0.982*tau2;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau2-0.982*tau2;
    }
    else if (ismc && (tree->tZTTGenMatching==1 or tree->tZTTGenMatching==3) && tree->tDecayMode==1){
        mymet=mymet+tau2-1.018*tau2;
        mymet_UESDown=mymet_UESDown+tau2-1.018*tau2;
        mymet_UESUp=mymet_UESUp+tau2-1.018*tau2;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-1.018*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-1.018*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-1.018*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-1.018*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-1.018*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-1.018*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-1.018*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-1.018*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-1.018*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-1.018*tau2;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau2-1.018*tau2;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau2-1.018*tau2;
    }
    if (ismc && (tree->tZTTGenMatching==2 or tree->tZTTGenMatching==4) && tree->tDecayMode==0){
        ...
        mymet=mymet+tau2-0.992*tau2;
        mymet_UESDown=mymet_UESDown+tau2-0.992*tau2;
        mymet_UESUp=mymet_UESUp+tau2-0.992*tau2;
        mymet_JetEta0to3Up=mymet_JetEta0to3Up+tau2-0.992*tau2;
        mymet_JetEta0to3Down=mymet_JetEta0to3Down+tau2-0.992*tau2;
        mymet_JetEC2Up=mymet_JetEC2Up+tau2-0.992*tau2;
        mymet_JetEC2Down=mymet_JetEC2Down+tau2-0.992*tau2;
        mymet_JetRelativeSampleUp=mymet_JetRelativeSampleUp+tau2-0.992*tau2;
        mymet_JetRelativeSampleDown=mymet_JetRelativeSampleDown+tau2-0.992*tau2;
        mymet_JetEta3to5Up=mymet_JetEta3to5Up+tau2-0.992*tau2;
        mymet_JetEta3to5Down=mymet_JetEta3to5Down+tau2-0.992*tau2;
        mymet_JetRelativeBalUp=mymet_JetRelativeBalUp+tau2-0.992*tau2;
        mymet_JetRelativeBalDown=mymet_JetRelativeBalDown+tau2-0.992*tau2;
        mymet_JetEta0to5Up=mymet_JetEta0to5Up+tau2-0.992*tau2;
        mymet_JetEta0to5Down=mymet_JetEta0to5Down+tau2-0.992*tau2;
    }
  ...
  mjj_JetEta0to3Up=tree->vbfMassWoNoisyJets_JetEta0to3Up;
  mjj_JetEta0to3Down=tree->vbfMassWoNoisyJets_JetEta0to3Down;
  mjj_JetEC2Up=tree->vbfMassWoNoisyJets_JetEC2Up;
  mjj_JetEC2Down=tree->vbfMassWoNoisyJets_JetEC2Down;
  mjj_JetEta3to5Up=tree->vbfMassWoNoisyJets_JetEta3to5Up;
  mjj_JetEta3to5Down=tree->vbfMassWoNoisyJets_JetEta3to5Down;
  mjj_JetEta0to5Up=tree->vbfMassWoNoisyJets_JetEta0to5Up;
  mjj_JetEta0to5Down=tree->vbfMassWoNoisyJets_JetEta0to5Down;
