...
using namespace std;
float trg_singleelectron_27, trg_singleelectron_32, trg_singleelectron_35, trg_crossele_ele24tau30;
float htxs_stage0cat, htxs_stage1cat, flagMETFilter, byVLooseIsolationMVArun2017v2DBoldDMwLT_2, byTightIsolationMVArun2017v2DBoldDMwLT_2;
float L1iso, L1pt;
...
float e_2, px_2, py_2, pz_2, pt_2, phi_2, eta_2, m_2, q_2, d0_2, dZ_2, mt_2, iso_2, l2_decayMode, decayMode_2;
...
void fillTree(TTree *Run_Tree, HTauTauTree_et *tree, int entry_tree, int recoil, bool ismc){
    ...
    passEle24Tau30=tree->Ele24Tau30Pass;
    ...
    htxs_stage0cat=tree->Rivet_stage0_cat;
    htxs_stage1cat=tree->Rivet_stage1_cat_pTjet30GeV;
    ...
    //flagMETFilter=!tree->Flag_goodVertices && !tree->Flag_globalTightHalo2016Filter && !tree->Flag_HBHENoiseFilter && !tree->Flag_HBHENoiseIsoFilter && !tree->Flag_EcalDeadCellTriggerPrimitiveFilter && !tree->Flag_BadPFMuonFilter && !tree->Flag_BadChargedCandidateFilter && !tree->Flag_ecalBadCalibFilter;
    ...
    njetsWoNoisyJets = tree->jetVeto30;
    ...
    if (ismc && tree->tZTTGenMatching<5 && tree->tDecayMode==0) tau2=tau2*1.003;
    else if (ismc && tree->tZTTGenMatching<5 && tree->tDecayMode==1) tau2=tau2*1.036;

    l2_decayMode=tree->tDecayMode;
    decayMode_2=tree->tDecayMode;
    ...
    trg_singleelectron_27=float(bool(tree->Ele27WPTightPass>0 && tree->eMatchesEle27Path>0 && tree->eMatchesEle27Filter>0 && tau1.Pt()>28));
    trg_singleelectron_32=float(bool(tree->Ele32WPTightPass>0 && tree->eMatchesEle32Path>0 && tree->eMatchesEle32Filter>0 && tau1.Pt()>33));
    trg_singleelectron_35=float(bool(tree->Ele35WPTightPass>0 && tree->eMatchesEle35Path>0 && tree->eMatchesEle35Filter>0 && tau1.Pt()>36));
    trg_crossele_ele24tau30=float(bool(tree->Ele24Tau30Pass>0 && tree->eMatchesEle24Tau30Path>0 && tree->tMatchesEle24Tau30Path>0 && tree->eMatchesEle24Tau30Filter>0 && tree->tMatchesEle24Tau30Filter>0 && tau1.Pt()>25 && tau2.Pt()>35 && fabs(tau2.Eta())<2.1));
    ...
    byVLooseIsolationMVArun2017v2DBoldDMwLT_2=tree->tRerunMVArun2v2DBoldDMwLTVLoose;
    byTightIsolationMVArun2017v2DBoldDMwLT_2=tree->tRerunMVArun2v2DBoldDMwLTTight;
    ...
    if (tree->jetVeto20WoNoisyJets>1) mjj=tree->vbfMassWoNoisyJets;
    else mjj=-10;
